...
jest.mock('lib/api', () => ({
  ...
  validateActionBody: jest.fn(),
}));

import handler from 'pages/api/backoffice/pages/[id]/actions';
...
describe('POST /api/backoffice/pages/[id]/actions', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    ...
    const { validateActionBody } = require('lib/api');
    validateActionBody.mockImplementation(() => undefined);
  });
  ...
  it('returns 400 when action is missing', async () => {
    ...
    const { validateActionBody } = require('lib/api');
    validateActionBody.mockImplementation(() => {
  ...
  it('returns 201 when action is created successfully', async () => {
    let callCount = 0;
...
describe('DELETE /api/backoffice/pages/[id]/actions', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    mockRequirePolicy.mockResolvedValue({
      ok: true,
  ...
  it('returns 200 when action is deleted successfully', async () => {
    let callCount = 0;
