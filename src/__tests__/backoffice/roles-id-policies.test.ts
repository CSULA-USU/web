...
import handler from 'pages/api/backoffice/roles/[id]/policies';
...
describe('POST /api/backoffice/roles/[id]/policies', () => {
  beforeEach(() => {
    jest.clearAllMocks();
...
describe('DELETE /api/backoffice/roles/[id]/policies', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    mockRequirePolicy.mockResolvedValue({
      ok: true,
